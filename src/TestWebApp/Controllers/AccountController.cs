...
namespace TestWebApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        IUser userManager = new UserService.UserManager();
        private INotificationActor notificationManager = new NotificationManager();
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<IActionResult> Login(RegisterViewModel entry)
        {
            ...
            try
            {
                var user = await userManager.GetUserByEmailAsync(entry.Email);
                if (user != null)
                {
